      ...
      <header className="py-4 md:py-6">
        <div className="container flex items-center justify-between px-4 md:px-6">
          <Link className="flex space-x-2 font-bold" href="#">
            <span className="text-pink-500">Do</span>
            <span className="text-blue-500">Ku</span>
          </Link>
          <nav className="hidden space-x-4 text-sm font-medium lg:flex">
            <Link
              className="text-gray-900 dark:text-gray-100 hover:text-gray-900/50 dark:hover:text-gray-100/50"
              href="#"
            >
              Home
            </Link>
        ...
        <div className="container py-6 space-y-6 md:py-10 md:space-y-10 lg:space-y-16">
          ...
          <div className="grid gap-6 px-4 md:grid-cols-3 md:gap-10 md:px-6">
            <div className="space-y-4">
              ...
              <Link
                className="inline-flex items-center underline hover:text-gray-900 dark:hover:text-gray-50"
                href="#"
              >
                Read more
        ...
        <div className="container flex flex-col gap-4 py-6 md:py-10 lg:gap-10 xl:gap-4 xl:flex-row xl:justify-between">
          ...
          <div className="flex items-center space-x-4 text-sm md:space-x-2 lg:space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <Link
                className="rounded-full w-6 h-6 overflow-hidden border-2 border-gray-200 border-gray-200 shadow-sm dark:border-gray-800 dark:border-gray-800"
                href="#"
              >
                <img
                  alt="Avatar"
